	...
	return (
		<PageLayout>
			<section className={classes.pageWrapper}>
				...
				<div className={classes.aboutBoxWrapper}>
					<address>
						<h2 className={classes.aboutHeader}>Kontaktinformation</h2>
					...
					<div>
						<h2 className={classes.aboutHeader}>Åbningstider</h2>
					...
					<div>
						<h2 className={classes.aboutHeader}>Kviklinks</h2>
						<p>
