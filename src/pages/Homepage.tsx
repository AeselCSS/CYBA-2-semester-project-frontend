		...
		<PageLayout>
			<section className={classes.pageWrapper}>
				...
				<div className={classes.homepageGrid}>
					<img src='homepage-pic3.jpg' alt='mechanics working on a car' />
					<div>
						<p>
							Velkommen til Kim Dehn Auto - din dedikerede partner inden for autoarbejde. Hvem er vi? Vi er et erfarent team
							af teknikere, der lægger stor vægt på faglig kvalitet og højt serviceniveau. Vores engagement i bilindustrien
							strækker sig over projekter af alle størrelser, og vi er stolte af at kunne tilbyde professionelle løsninger.
						</p>
						<br />
						<p>
					...
					<div>
						<p>
							...
							løbende i opgradering af værktøj og udstyr, så vi kan håndtere de nyeste bilmodeller og avancerede teknologier
							på markedet. Uanset om det drejer sig om almindelig vedligeholdelse, reparationer eller teknologiske
							opgraderinger, kan du stole på, at vi leverer en professionel og pålidelig service.
						</p>
						<br />
						<p>
